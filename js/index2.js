ReactDOM.render(
    <div>
        ...
        <div class = "stats">
            <div class = "speed">
                <h2><span>Speed: </span><span id = "speed">-</span><span> СPM </span><img  title = "CPM (Clicks Per Minute) - standart unit of measurement, characterized by frequency of clicks per minute" class = "sign" src = "question.jpg"></img></h2>
            </div>
            <div class = "speed">
                <h2><span>Accuracy: </span><span id = "accuracy">-</span><span> % </span><img  title = "Percent right typed symbols from the all count of clicks" class = "sign" src = "question.jpg"></img></h2>
            </div>
        </div>
        <br></br>
