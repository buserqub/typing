ReactDOM.render(
    <div>
        ...
        <div class = "stats">
            <div class = "speed">
                <h2><span>Скорость: </span><span id = "speed">-</span><span> СPM </span><img  title = "CPM (Clicks Per Minute) - стандартная единица измерения скорости, характеризующаяся частотой нажатий клавиш в минуту" class = "sign" src = "question.jpg"></img></h2>
            </div>
            <div class = "speed">
                <h2><span>Точность: </span><span id = "accuracy">-</span><span> % </span><img  title = "Процент правильно введенных символов от общего количества нажатий клавиш" class = "sign" src = "question.jpg"></img></h2>
            </div>
        </div>
        <br></br>
